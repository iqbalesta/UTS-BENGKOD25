<x-layouts.app title="Pasien Dashboard">
    @php
        ...
        $myRegistrations = \App\Models\DaftarPoli::where('id_teknisi', $user->id)->with(['jadwalPeriksa.poli','jadwalPeriksa.dokter'])->latest()->take(5)->get();
        $upcoming = \App\Models\DaftarPoli::where('id_teknisi', $user->id)->with(['jadwalPeriksa'])->whereHas('jadwalPeriksa')->orderBy('id')->first();
    @endphp
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="info-box bg-primary">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ \App\Models\DaftarPoli::where('id_teknisi', $user->id)->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
